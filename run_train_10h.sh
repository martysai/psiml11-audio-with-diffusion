...
TRAIN_SUBSET_DIR="<user-home>/Desktop/psiml/datasets/LibriSpeech/train-clean-100_10h"
...
VALID_SUBSET_DIR="<user-home>/Desktop/psiml/datasets/LibriSpeech/dev-clean_60min"
