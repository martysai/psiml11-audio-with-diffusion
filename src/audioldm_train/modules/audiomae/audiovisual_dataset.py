...
class AudioVisualDataset(Dataset):
    ...
    def __init__(
        ...
        datafiles=[
            ...
            "/path/to/audioset_balanced_train.json",
        ],
        min_video_frames=30,
    ...
    def _prepare_audioset(self):
        # NOTE: Anonymized for double-blind review (remove user-specific absolute paths).
        df1 = pd.read_csv(
            "/path/to/audioset/metadata/class_labels_indices.csv",
            delimiter=",",
            skiprows=0,
        )
